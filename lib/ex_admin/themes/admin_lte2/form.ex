defmodule ExAdmin.Theme.AdminLte2.Form do
  ...
  def build_actions_block(conn, _model_name, mode) do
    ...
    div ".box-footer" do
      Xain.input(".btn.btn-primary",
        name: "commit",
        type: :submit,
        value: escape_value("#{label} #{humanize(display_name)}")
      )

      a(".btn.btn-default.btn-cancel " <> gettext("Cancel"),
      ...
      div ".box.has_many_fields" do
        ...
        div ".box-body" do
          ...
          for field <- fields do
            ...
            errors =
              get_errors(errors, "#{model_name}[#{field_field_name}][#{orig_inx}][#{f_name}]")
          ...
          unless Schema.get_id(res) do
            div ".form-group" do
              a(".btn.btn-default " <> gettext("Delete"),
                href: "#",
