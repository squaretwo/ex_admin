defmodule ExAdmin.Theme.AdminLte2.Index do
  ...
  def batch_action_form(_conn, enabled?, scopes, name, _scope_counts, fun) do
    msg =
      gettext("Are you sure you want to delete these %{name}? You wont be able to undo this.",
        name: name
      )
              ...
              div "#batch_actions_selector.dropdown_menu" do
                ...
                div ".dropdown_menu_list_wrapper", style: "display: none;" do
                  ...
                  ul ".dropdown_menu_list" do
                    li do
                      a(".batch_action " <> gettext("Delete Selected"),
                        href: "#",
                        "data-action": :destroy,
                        "data-confirm": msg
                      )
          ...
          if selectable do
            td(".selectable") do
              div(".resource_selection_cell") do
                input(".collection_selection#batch_action_item_#{id}",
                  type: :checkbox,
                  value: "#{id}",
